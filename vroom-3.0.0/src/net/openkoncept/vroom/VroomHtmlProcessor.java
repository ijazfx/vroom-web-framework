...
/**
 * <p>
 * This class contains some utility methods used by Vroom framework. The purpose of these methods is to modify the
 * request html output to include required scripts and stylesheets whichever applicable.
 * </p>
 *
...
public class VroomHtmlProcessor {
    ...
    /**
     * <p>
     * This method adds all the meta tags in the &lt;head&gt; section. These tags are defined in the
     * vroom's configuration file.
     * </p>
     *
    ...
    public static void addHeadMetaTags(StringBuffer sbHtml, String uri, VroomConfig vc) {
        Iterator iter = vc.getWebpages().iterator();
        while (iter.hasNext()) {
            Webpage wp = (Webpage) iter.next();
            if (uri.matches(wp.getUri())) {
                Iterator metas = wp.getMetas().iterator();
                if (metas.hasNext()) {
                    StringBuffer sbMetas = new StringBuffer();
                    while (metas.hasNext()) {
                        Meta meta = (Meta) metas.next();
    ...
    /**
     * This function is generates &lt;link&gt; tag for all link, rss and rdf definitions in vroom-config file.
     *
    ...
    public static void addHeadLinks(StringBuffer sbHtml, String uri, VroomConfig vc) {
        ...
        while (iter.hasNext()) {
            Webpage wp = (Webpage) iter.next();
            if (uri.matches(wp.getUri())) {
                Iterator links = wp.getLinks().iterator();
                if (links.hasNext()) {
    ...
    /**
     * <p>
     * This method adds required script tags such as to access "vroom.js" file.
     * </p>
     *
     * @param sbHtml - Source HTML
     * @param hreq   - Request
    ...
    /**
     * <p>
     * This method adds all the applicable script tags in the &lt;head&gt; section. These tags are defined in the
     * vroom's configuration file.
     * </p>
     *
    ...
    public static void addHeadScripts(StringBuffer sbHtml, String uri, VroomConfig vc, HttpServletRequest req) {
        ...
        while (iter.hasNext()) {
            Webpage wp = (Webpage) iter.next();
            if (uri.matches(wp.getUri())) {
                Iterator scripts = wp.getScripts().iterator();
                if (scripts.hasNext()) {
    ...
    /**
     * <p>
     * This method adds &lt;link&gt; tag in the head section for all the stylesheets defined for the request in vroom's
     * configuration file.
     * </p>
     *
    ...
    public static void addStylesheets(StringBuffer sbHtml, String uri, VroomConfig vc, HttpServletRequest req) {
        ...
        while (iter.hasNext()) {
            Webpage wp = (Webpage) iter.next();
            if (uri.matches(wp.getUri())) {
                Iterator stylesheets = wp.getStylesheets().iterator();
                if (stylesheets.hasNext()) {
                    StringBuffer sbStylesheets = new StringBuffer();
                    while (stylesheets.hasNext()) {
                        Stylesheet stylesheet = (Stylesheet) stylesheets.next();
                        StringBuffer sb = new StringBuffer();
                        ...
                        if (stylesheet.getUrl() != null) {
                            ...
                            sb.append("<style>\n").append(stylesheet.getText()).append("\n</style>\n");
                        }
    ...
    /**
     * <p>
     * This method adds the &lt;script&gt; tag before the &lt;/html&gt; tag to call request sepcific init() method.
     * All event bindings happen init() method of the request.
     * </p>
     *
     * @param sbHtml - Source HTML
    ...
    /**
     * <p>
     * This method inserts a text in a string buffer before a specific text.
     * </p>
     *
    ...
    /**
     * <p>
     * This method inserts a text in a string buffer after a specific text.
     * </p>
     *
     * @param sb           - Source String Buffer
     * @param text         - Text to find
    ...
    /**
     * <p>
     * This method inserts a text in a string buffer before or after a specific text based on the value of after flag.
     * </p>
     *
     * @param sb           - Source String Buffer
     * @param text         - Text to find
     * @param textToInsert - Text to insert before or after the found text
     * @param after        - if true the value is inserted after the found text otherwise before.
     */
    ...
    /**
     * <p>
     * This method is used to replace a text with some other text.
     * </p>
     *
     * @param sb          - Source String Buffer
     * @param text        - Text to find
    ...
    /**
     * <p>
     * This method generates the postback script which is used to update form fields.
     * </p>
     *
     * @param sbHtml      - HTML source code
     * @param uri         - Webpage URI
    ...
    public static void addPostbackScript(StringBuffer sbHtml, String uri, HttpServletRequest hreq, Map postbackMap) {
        ...
        while (iter.hasNext()) {
            ...
            Object value = postbackMap.get(key);
            JSONObject jo;
            try {
