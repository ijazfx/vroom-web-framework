 ...
 */
        ...
        try {
            j = XML.toJSONObject("<![CDATA[This is a collection of test patterns and examples for net.openkoncept.json.]]>  Ignore the stuff past the end.  ");
